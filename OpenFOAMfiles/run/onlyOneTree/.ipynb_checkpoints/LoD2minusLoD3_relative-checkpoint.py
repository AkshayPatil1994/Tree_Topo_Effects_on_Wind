...
surface_U1 = pv.read('./LoD3/conifer_im/postProcessing/surfaces/752/U_z10Normal.vtk') ###---------need to be changed---------##
surface_U2 = pv.read('./LoD3/conifer_ex/postProcessing/surfaces/752/U_z10Normal.vtk')
...
plotter.show(screenshot='./relative_canopy/conifer_LoD3_ex-im.png')
